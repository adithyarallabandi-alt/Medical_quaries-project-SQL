create database medical_quaries;
use medical_quaries;
...
-- 21. Show total male and female patients in same row.
select
...
select day(admission_date) as day_of_month, count(*) as total
from admissions
group by day_of_month
order by total desc, day_of_month;
